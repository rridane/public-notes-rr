...
---
### [deep_dive_in_ebpf_cilium_hubble.adoc](devops/deep_dive_in_ebpf_cilium_hubble.adoc)
> eBPF & Cilium datapath deep dive: a minimal map/hook/verdict program, a packet traced phase by phase from the connect() socket hook to overlay delivery, what kube-proxy and iptables no longer own, and Hubble flow observability.
